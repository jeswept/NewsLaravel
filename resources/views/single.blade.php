@include('header')
		...
		<div class="row fh5co-post-entry single-entry">
			<article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
				<figure class="animate-box">
					<img src="{{url('assets/images/single_1.jpg')}}" alt="Image" class="img-responsive">
				</figure>	
				<span class="fh5co-meta animate-box"><a href="{{url('single')}}">Travel</a></span>
				<h2 class="fh5co-article-title animate-box"><a href="{{url('single')}}">My First Time Traveling in Vietnam</a></h2>
				...
				<div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
					...
					<div class="row rp-b">
						<div class="col-lg-6 col-md-12 animate-box">
							<figure>
								<img src="{{url('assets/images/pic_1.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
					...
					<div class="row rp-b">
						<div class="col-lg-6 col-lg-push-6 col-md-12 col-md-push-0 animate-box">
							<figure>
								<img src="{{url('assets/images/pic_4.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
								<figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</figcaption>
							</figure>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 animate-box">
							<figure>
								<img src="{{url('assets/images/pic_5.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
								<figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</figcaption>
							</figure>
						</div>s
						<div class="col-md-4 animate-box">
							<figure>
								<img src="{{url('assets/images/pic_6.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
								<figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</figcaption>
							</figure>
						</div>
						<div class="col-md-4 animate-box">
							<figure>
								<img src="{{url('assets/images/pic_7.jpg')}}" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
								<figcaption>This is a sweet image caption. Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</figcaption>
							</figure>
						</div>
						<div class="col-md-12 animate-box">
	...
	<footer id="fh5co-footer">
		<p><small>&copy; 2022. AlfaNova . All Rights Reserverd. <br> Designed by <a href="http://www.bahadirlar.com" target="_blank">AlfaNoVa</a><a></a></small></p>
	</footer>
